...
try {
    if ($method === 'POST' && isset($_POST['name'], $_POST['email'], $_POST['age'])) {
        $userManager->addUser($_POST['name'], $_POST['email'], (int) $_POST['age']);
        ...
        if (isset($_PUT['id'], $_PUT['name'], $_PUT['email'], $_PUT['age'])) {
            $userManager->updateUser($_PUT['id'], $_PUT['name'], $_PUT['email'], (int) $_PUT['age']);
